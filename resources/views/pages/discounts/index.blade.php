  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div
      ...
      <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Reglas de descuento </h2>
      </header>
      <div class="p-3">
        ...
        <div class="overflow-x-auto">
          ...
          <table id="tabladatos" class="display text-lg" style="width:100%">
            ...
            <tbody>
              ...
              @foreach ($reglasDescuento as $item)
                <tr>
                  <td>{{ $item->name }}</td>
...
<script>
  $('document').ready(function() {
    ...
    $(".btn_swithc").on("change", function() {
      ...
      $.ajax({
        url: "{{ route('reglasDescuentos.updateVisible') }}",
        method: 'POST',
        data: {
    ...
    $(".btn_delete").on("click", function(e) {
      ...
      Swal.fire({
        ...
        text: "Vas a eliminar una regla de descuento",
        icon: "warning",
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            url: "{{ route('reglasDescuentos.deletereglasDescuentos') }}",
            method: 'POST',
            data: {
              _token: $('input[name="_token"]').val(),
              id: id,
