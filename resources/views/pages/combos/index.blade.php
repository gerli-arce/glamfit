    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <section class="py-4 border-b border-slate-100 dark:border-slate-700">
            <a href="{{ route('combos.create') }}"
                class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded text-sm">Crear Combo</a>
        </section>
        ...
        <div
            ...
            <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Combos</h2>
            </header>
            <div class="p-3">
                                    ...
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        <div class="flex items-center text-slate-800">
                                            <div
                                                ...
                                                <img class="rounded-full ml-1 h-8 w-8 object-contain"
                                                    src="{{ asset($item->imagen) }}" alt="{{ $item->titulo }}" />
                                            </div>
                                        </div>
                                    </td>
                                    <td class="">{{ $item->titulo }}</td>
                                    <td class="">{{ $item->precio }}</td>
                                    <td class="">{{ $item->precio_tachado }}</td>
                                    ...
                                    <td class="">
                                        <form method="POST" action="">
                                            ...
                                            <input type="checkbox" id="hs-basic-usage"
                                                ...
                                                data-titleService='{{ $item->titulo }}' {{ $item->destacar == 1 ? 'checked' : '' }}>
                                            <label for="{{ 'd_' . $item->id }}"></label>
                                        </form>
                                    </td>
                                    ...
                                    <td class="">
                                        <form method="POST" action="">
                                            ...
                                            <input type="checkbox" id="hs-basic-usage"
                                                ...
                                                data-idService='{{ $item->id }}' data-titleService='{{ $item->titulo }}' {{ $item->status == 1 ? 'checked' : '' }}>
