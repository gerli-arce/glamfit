    ...
    <form action="{{ route('strength.update', $strength->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div
        ...
        <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
          <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Editar promoción
          </h2>
        </header>
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="number" id="order" name="order" value="{{$strength->order}}"
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <textarea type="text" id="descripcion" name="descripcion"
                    class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Nosotros...">{{ $strength->descripcion }}</textarea>
                </div>
              </div>
