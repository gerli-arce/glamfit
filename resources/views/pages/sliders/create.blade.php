                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div class="md:col-span-5">
                                                ...
                                                <div class="relative mb-2  mt-2">
                                                    ...
                                                    <input type="number" id="order" name="order" value="" class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingresa el numero de orden">
                                                </div>
                                            </div>
                                            ...
                                            <div class="md:col-span-5">
                                             ...
                                             <div class="md:col-span-5">
                                                <label for="link1">Subir una imagen (.png/.jpg) (Version Mobile)</label>
                                                <div class="relative mb-2  mt-2">
                                                    <input id="link1" name="link1" class="p-2.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="user_avatar" type="file">
                                                </div>
                                             </div>
