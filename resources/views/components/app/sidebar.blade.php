  ...
  <div id="sidebar"
    ...
    <div class="space-y-8">
      ...
      <x-menu.group title="Sistema">
        ...
        {{-- <x-menu.item id="testimonios" href="{{ route('testimonios.index') }}" icon="fas fa-star">Testimonios
        </x-menu.item> --}}
      </x-menu.group>
      ...
      <x-menu.group title="Productos">
        ...
        <x-menu.item id="combos" href="{{ route('combos.index') }}" icon="fas fa-layer-group">Combos</x-menu.item>
      ...
      <x-menu.group title="Datos de la empresa">
        <x-menu.item id="datosgenerales" href="{{ route('datosgenerales.edit', 1) }}" icon="fas fa-address-card">Datos
          Generales</x-menu.item>
        {{-- <x-menu.item id="shortcode" href="{{ route('shortcode.edit', 1) }}" icon="fas fa-address-card">Shortcode
          Head/Body</x-menu.item> --}}
        ...
        {{-- <x-menu.item id="servicios" href="{{ route('servicios.index') }}" icon="fa fa-solid fa-image">Logos
          footer</x-menu.item> --}}
        <x-menu.item id="popup" href="{{ route('popup.index') }}" icon="fas fa-sliders-h">Popup</x-menu.item>

        <x-menu.item id="reglasdedescuento" href="{{ route('reglasDescuentos.index') }}">Reglas de
          descuento</x-menu.item>
        {{-- <x-menu.item id="cupones" href="{{ route('cupones.index') }}"
          icon="fa-solid fa-ticket">Cupones</x-menu.item> --}}
        ...
        {{-- <x-menu.item id="politicas-de-devolucion" href="{{ route('politicas-de-devolucion.edit', 1) }}"
          icon="fas fa-undo-alt">Politicas de Devolucion</x-menu.item> --}}
        {{-- <x-menu.item id="terminos-y-condiciones" href="{{ route('terminos-y-condiciones.edit', 1) }}"
          icon="fas fa-file-contract">Terminos y Condiciones</x-menu.item> --}}
        {{-- <x-menu.item id="politica-datos" href="{{ route('politicadatos.detalle', 1) }}"
          icon="fas fa-file-contract">Terminos Datos</x-menu.item> --}}

        {{-- <x-menu.item id="tiempo-y-costos-envio" href="{{ route('tiempo-y-costos-envio.edit', 1) }}"
          icon="fas fa-file-contract">Tiempo y Costos de Envío</x-menu.item> --}}
        {{-- <x-menu.item id="plazos-de-reembolso" href="{{ route('plazos-de-reembolso.edit', 1) }}"
          icon="fas fa-file-contract">Plazos de Reembolso</x-menu.item> --}}
        {{-- <x-menu.item id="tratamiento-adicional-datos" href="{{ route('tratamiento-adicional-datos.edit', 1) }}"
          icon="fas fa-file-contract">Tratamiento Adicional Datos</x-menu.item> --}}
        {{-- <x-menu.item id="politica-cookies" href="{{ route('politica-cookies.edit', 1) }}"
          icon="fas fa-file-contract">Políticas de cookies</x-menu.item> --}}
        {{-- <x-menu.item id="campanas-publicitarias" href="{{ route('campanas-publicitarias.edit', 1) }}"
          icon="fas fa-file-contract">Campañas Publicitarias</x-menu.item> --}}
        {{-- <x-menu.item id="beneficios-cero-intereses" href="{{ route('beneficios-cero-intereses.edit', 1) }}"
          icon="fas fa-file-contract">Beneficios 0 Intereses</x-menu.item> --}}
        {{-- <x-menu.item id="seguimiento-de-pedido" href="{{ route('seguimiento-de-pedido.edit', 1) }}"
          icon="fas fa-file-contract">Seguimiento de pedido</x-menu.item> --}}
        {{-- <x-menu.item id="nuestras-tiendas" href="{{ route('nuestras-tiendas.edit', 1) }}"
          icon="fas fa-file-contract">Nuestras tiendas</x-menu.item> --}}

        {{-- <x-menu.item id="sobrenosotros" href="{{ route('aboutus.index') }}" icon="fas fa-address-card">Sobre
          Nosotros</x-menu.item> --}}
        {{-- <x-menu.item id="faqs" href="{{ route('faqs.index') }}" icon="fas fa-address-card"> Preguntas
          Frecuentes</x-menu.item> --}}
