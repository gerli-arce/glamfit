...
const FilterContainer = ({ minPrice, setFilter, filter, maxPrice, categories = [], tags = [], marcas = [], brands = [], sizes = [], colors = [], colores = [], attribute_values, tag_id, marcas_id, selected_category }) => {
  ...
  return (<>
...

    {
      categories.length > 0 && (
        ...
        <div className="w-full ">
          <h2 className="font-Urbanist_Semibold tracking-wide font-semibold text-base mb-4">Categorías</h2>
...

    {
      categories.length > 0 && (
        <div className="w-full">
          <h2 className="font-Urbanist_Semibold tracking-wide font-semibold text-base mb-4">Subcategorías</h2>
          <div className="bg-[#808080] pb-[1px] -mt-2 mb-5"></div>
